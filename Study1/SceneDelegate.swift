...
class SceneDelegate: UIResponder, UIWindowSceneDelegate {
    ...
    //statistic flow
    let statisicVC = ViewController()
    let statisicNAV = UINavigationController(rootViewController: statisicVC)
        statisicNAV.tabBarItem = UITabBarItem(
            title: "Статистика",
    ...
    //products flow
    let productsVC = ProductsListView()
